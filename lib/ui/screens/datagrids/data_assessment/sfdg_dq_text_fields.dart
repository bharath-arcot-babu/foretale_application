        ...
        columns: <GridColumn>[
          ...
          GridColumn(
            ...
            label: Container(
              padding: const EdgeInsets.all(4.0),
              alignment: Alignment.center,
              child: Text('Distinct', style: TextStyles.gridHeaderText(context)),
            ),
          ),
          GridColumn(
            ...
            label: Container(
              padding: const EdgeInsets.all(4.0),
              alignment: Alignment.center,
              child: Text('Duplicates', style: TextStyles.gridHeaderText(context)),
            ),
          ),
          GridColumn(
            ...
            label: Container(
              padding: const EdgeInsets.all(4.0),
              alignment: Alignment.center,
              child: Text('Non-Compliant', style: TextStyles.gridHeaderText(context)),
            ),
          ),
        ],
      ),
